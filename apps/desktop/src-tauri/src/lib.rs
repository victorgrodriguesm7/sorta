...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            // The `link` module is split into focused submodules; each
            // command is registered at its canonical submodule path so
            // `tauri::generate_handler!` can find the hidden `__cmd__`
            // companion items emitted next to the function.
            commands::link::single::link_media,
            commands::link::rename::rename_media,
            commands::link::genres::list_media_genres,
            commands::link::genres::reorder_media_genres,
            commands::link::series::link_as_series,
            commands::link::episodes::list_episodes,
            commands::link::recatalog::plan::plan_recatalog_series,
            commands::link::recatalog::run::recatalog_series,
            commands::link::episodes::set_media_is_new,
            commands::link::episodes::update_season_label,
            commands::link::unlink::unlink_media,
